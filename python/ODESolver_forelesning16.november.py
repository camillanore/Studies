...
class ODESolver:
    ...
    def set_initial_condition(self, U0):
        ...
        # Check that f returns correct length: (at høyresidefunksjonen returnere
        # like mange komponenter.). Hovedfunk: introduseres self.neq = 1 
        # system av ODEer settes til lengden av U? 
        try:
            f0 = self.f(self.U0, 0)
        except IndexError:
